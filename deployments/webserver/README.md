...
Module `sdkwork-prompts` · runtime code `prompts` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `prompts-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `prompts-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `prompts-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `prompts-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `prompts.sdkwork.com` | 443 ssl + 80 |
