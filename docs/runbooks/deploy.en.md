# Runbook — sdkwork-prompts deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-prompts-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-prompts/bundle`, loads the image, starts
