# sdkwork-prompts Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-prompts` |
| `runtimeCode` | `prompts` |
| Config root | `/etc/sdkwork/prompts/` |
| Runtime TOML | `/etc/sdkwork/prompts/config.toml` |
| Secrets | `/etc/sdkwork/prompts/secrets/` |
| Override | `SDKWORK_PROMPTS_CONFIG_FILE` |
