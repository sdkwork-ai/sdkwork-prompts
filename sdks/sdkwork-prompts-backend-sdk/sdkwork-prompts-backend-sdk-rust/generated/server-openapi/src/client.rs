...
use crate::api::{PromptsAdminApi};
use crate::http::{SdkworkConfig, SdkworkError, SdkworkHttpClient};

#[derive(Clone)]
pub struct SdkworkPromptsBackendClient {
    http: Arc<SdkworkHttpClient>,
}

impl SdkworkPromptsBackendClient {
    ...
    pub fn prompts_admin(&self) -> PromptsAdminApi {
            PromptsAdminApi::new(Arc::clone(&self.http))
        }
}
