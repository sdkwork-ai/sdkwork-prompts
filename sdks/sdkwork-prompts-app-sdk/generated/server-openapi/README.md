...
```typescript
import { SdkworkPromptsAppClient } from '@sdkwork/prompts-app-sdk';

const client = new SdkworkPromptsAppClient({
  baseUrl: '/app/v3/api',
  timeout: 30000,
});
...
```typescript
import { SdkworkPromptsAppClient, NetworkError, TimeoutError, AuthenticationError } from '@sdkwork/prompts-app-sdk';
